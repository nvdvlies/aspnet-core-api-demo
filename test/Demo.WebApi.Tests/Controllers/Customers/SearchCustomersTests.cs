...
public class SearchCustomersTests : TestBase
{
    ...
    public async Task SearchCustomers_When_2_customers_exist_It_should_return_2_customers()
    {
        ...
        var query = new SearchCustomersQuery { OrderBy = SearchCustomersOrderByEnum.Name, OrderByDescending = false };
        ...
        SearchCustomers_When_ordering_by_customer_code_ascending_It_should_return_list_in_correct_order()
    {
        ...
        var query = new SearchCustomersQuery { OrderBy = SearchCustomersOrderByEnum.Code, OrderByDescending = false };
        ...
        SearchCustomers_When_ordering_by_customer_code_descending_It_should_return_list_in_correct_order()
    {
        ...
        var query = new SearchCustomersQuery { OrderBy = SearchCustomersOrderByEnum.Code, OrderByDescending = true };
        ...
        SearchCustomers_When_ordering_by_customer_name_descending_It_should_return_list_in_correct_order()
    {
        ...
        var query = new SearchCustomersQuery { OrderBy = SearchCustomersOrderByEnum.Name, OrderByDescending = true };
