...
namespace Demo.WebApi.Controllers
{
    public class PermissionsController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<GetAllPermissionsQueryResult>> All([FromQuery] GetAllPermissionsQuery query, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.InternalServerError)]
        public async Task<ActionResult<GetAllPermissionGroupsQueryResult>> GetAllPermissionGroups([FromQuery] GetAllPermissionGroupsQuery query, CancellationToken cancellationToken)
        {
            return await Mediator.Send(query, cancellationToken);
        }
