...
{
    internal class OutboxMessageValidator : AbstractValidator<OutboxMessage>, Shared.Interfaces.IValidator<OutboxMessage>
    {
        public async Task<IEnumerable<ValidationMessage>> ValidateAsync(IDomainEntityContext<OutboxMessage> context, CancellationToken cancellationToken = default)
        {
